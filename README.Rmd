...
> :warning: **Early stages of development.** This package is in the early stages of development. Please do not assume there will be no breaking changes and check back regularly.

## Installation

You can install the latest "stable" version from [GitHub](https://github.com/) with:
...
The package includes a single example dataset `ex_smoking` constructed from the [BCEA](http://www.statistica.it/gianluca/software/bcea/) package, which we will use here:
